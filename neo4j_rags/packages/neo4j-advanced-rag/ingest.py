...
txt_path = Path(__file__).parent / "apt_mecher.txt"
#txt_path = Path(__file__).parent / "dune.txt"
txt_path = Path(__file__).parent / "PdfReader_example.txt"
graph = Neo4jGraph()
    ...
    [
        (
            ...
            (
                ...
                "questions. the text is Apartment Sales Specification and contains information about the building and the apartment. its published by the construction building "
                "main focus should be on the items that the construction building is commited to provide. the legistical part is meaningless in this context "
                "since the question would be about physical stuff of the apartment, building and sorrounding. the text is in hebrew"
            ),
        ),
        (
            "human",
    ...
    [
        (
            ...
            (
                ...
                "information found in the text. the text is Apartment Sales Specification and contains information about the building and the apartment. "
                "its published by the construction building. "
                "only focus should be on the items that the construction building is commited to provide. the legistical part is meaningless in this context "
                "since the question would be about physical stuff of the apartment, building and sorrounding. the text is in hebrew "
            ),
        ),
        (
